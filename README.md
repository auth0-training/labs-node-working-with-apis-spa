# Lab: Working with APIs from a SPA

In tihs [Okta Learning](https://learning.okta.com/) hands-on lab, learners will put their API knowledge into practice. They'll create an API in their Tenant, deploy a test API into the lab environment, obtain a test Access Token, and call the test API using the Access Token.
